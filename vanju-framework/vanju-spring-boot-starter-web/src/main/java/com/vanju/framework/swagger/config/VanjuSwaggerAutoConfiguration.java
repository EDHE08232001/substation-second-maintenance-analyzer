package com.vanju.framework.swagger.config;
...
import static com.vanju.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
// 设置为 false 时，禁用
public class VanjuSwaggerAutoConfiguration {
    ...
    public static GroupedOpenApi buildGroupedOpenApi(String group, String path) {
        return GroupedOpenApi.builder().group(group).pathsToMatch("/admin-api/" + path + "/**", "/app-api/" + path + "/**").addOperationCustomizer((operation, handlerMethod) -> operation.addParametersItem(buildTenantHeaderParameter()).addParametersItem(buildSecurityHeaderParameter())).build();
    }

package com.vanju.framework.apilog.core.interceptor;
...
import com.vanju.framework.common.util.spring.SpringUtils;
...
public class ApiAccessLogInterceptor implements HandlerInterceptor {
    ...
    private void printHandlerMethodPosition(HandlerMethod handlerMethod) {
        ...
        try {
            ...
            Optional<Integer> lineNumber = IntStream.range(0, clazzContents.size()).filter(i -> clazzContents.get(i).contains(" " + method.getName() + "(")) // 简单匹配，不考虑方法重名

package com.vanju.framework.apilog.core.filter;
...
import com.vanju.framework.apilog.core.annotation.ApiAccessLog;
import com.vanju.framework.apilog.core.enums.OperateTypeEnum;
import com.vanju.framework.common.exception.enums.GlobalErrorCodeConstants;
...
import com.vanju.framework.web.config.WebProperties;
import com.vanju.framework.web.core.filter.ApiRequestFilter;
import com.vanju.framework.web.core.util.WebFrameworkUtils;
import com.vanju.module.infra.api.logger.ApiAccessLogApi;
import com.vanju.module.infra.api.logger.dto.ApiAccessLogCreateReqDTO;
...
import static com.vanju.framework.apilog.core.interceptor.ApiAccessLogInterceptor.ATTRIBUTE_HANDLER_METHOD;
import static com.vanju.framework.common.util.json.JsonUtils.toJsonString;
...
public class ApiAccessLogFilter extends ApiRequestFilter {
    ...
    private boolean buildApiAccessLog(ApiAccessLogCreateReqDTO accessLog, HttpServletRequest request, LocalDateTime beginTime, Map<String, String> queryString, String requestBody, Exception ex) {
        ...
        // 设置请求字段
        accessLog.setApplicationName(applicationName).setRequestUrl(request.getRequestURI()).setRequestMethod(request.getMethod()).setUserAgent(ServletUtils.getUserAgent(request)).setUserIp(ServletUtils.getClientIP(request));

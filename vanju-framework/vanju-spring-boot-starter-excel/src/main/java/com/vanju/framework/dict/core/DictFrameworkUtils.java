package com.vanju.framework.dict.core;

import cn.hutool.core.util.ObjectUtil;
import com.google.common.cache.CacheLoader;
import com.google.common.cache.LoadingCache;
import com.vanju.framework.common.core.KeyValue;
import com.vanju.framework.common.util.cache.CacheUtils;
import com.vanju.module.system.api.dict.DictDataApi;
import com.vanju.module.system.api.dict.dto.DictDataRespDTO;
...
public class DictFrameworkUtils {
     ...
     */
    private static final LoadingCache<String, List<String>> GET_DICT_DATA_LIST_CACHE = CacheUtils.buildAsyncReloadingCache(Duration.ofMinutes(1L), // 过期时间 1 分钟

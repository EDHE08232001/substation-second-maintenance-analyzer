package com.vanju.framework.excel.core.handler;
...
import com.vanju.framework.common.core.KeyValue;
import com.vanju.framework.dict.core.DictFrameworkUtils;
import com.vanju.framework.excel.core.annotations.ExcelColumnSelect;
import com.vanju.framework.excel.core.function.ExcelColumnSelectFunction;
...
public class SelectSheetWriteHandler implements SheetWriteHandler {
    ...
    private void getSelectDataList(int colIndex, Field field) {
        ...
        Assert.isTrue(ObjectUtil.isNotEmpty(dictType) || ObjectUtil.isNotEmpty(functionName), "Field({}) 的 @ExcelColumnSelect 注解，dictType 和 functionName 不能同时为空", field.getName());
     ...
     * 设置单元格下拉选择
     */
    private static void setColumnSelect(WriteSheetHolder writeSheetHolder, Workbook workbook, DataValidationHelper helper, KeyValue<Integer, List<String>> keyValue) {
        // 1.1 创建可被其他单元格引用的名称

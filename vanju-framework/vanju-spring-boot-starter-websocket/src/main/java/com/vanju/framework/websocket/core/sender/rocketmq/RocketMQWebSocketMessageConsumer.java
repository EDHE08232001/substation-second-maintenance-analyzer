package com.vanju.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${vanju.websocket.sender-rocketmq.topic}",
        consumerGroup = "${vanju.websocket.sender-rocketmq.consumer-group}",

package com.vanju.framework.quartz.core.scheduler;

import com.vanju.framework.quartz.core.enums.JobDataKeyEnum;
import com.vanju.framework.quartz.core.handler.JobHandlerInvoker;
import org.quartz.*;

import static com.vanju.framework.common.exception.enums.GlobalErrorCodeConstants.NOT_IMPLEMENTED;
...
public class SchedulerManager {
    ...
    private void validateScheduler() {
        if (scheduler == null) {
            throw exception0(NOT_IMPLEMENTED.getCode(), "[定时任务 - 已禁用][参考 https://doc.vanju.cn/job/ 开启]");
        }
    }
}

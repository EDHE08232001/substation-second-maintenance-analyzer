package com.vanju.module.system.controller.oauth2;
...
import com.vanju.framework.common.util.http.HttpUtils;
import com.vanju.framework.common.util.json.JsonUtils;
import com.vanju.module.system.controller.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import com.vanju.module.system.controller.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import com.vanju.module.system.controller.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import com.vanju.module.system.convert.oauth2.OAuth2OpenConvert;
import com.vanju.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import com.vanju.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import com.vanju.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import com.vanju.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import com.vanju.module.system.service.oauth2.OAuth2ApproveService;
import com.vanju.module.system.service.oauth2.OAuth2ClientService;
import com.vanju.module.system.service.oauth2.OAuth2GrantService;
import com.vanju.module.system.service.oauth2.OAuth2TokenService;
import com.vanju.module.system.util.oauth2.OAuth2Utils;
...
import static com.vanju.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.vanju.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static com.vanju.framework.common.pojo.CommonResult.success;
import static com.vanju.framework.common.util.collection.CollectionUtils.convertList;
import static com.vanju.framework.security.core.util.SecurityFrameworkUtils.getLoginUserId;
...
public class OAuth2OpenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", description = "重定向 URI", example = "https://www.vanju.cn"),
    ...
    @Parameters({
            ...
            @Parameter(name = "redirect_uri", required = true, description = "重定向 URI", example = "https://www.vanju.cn"),

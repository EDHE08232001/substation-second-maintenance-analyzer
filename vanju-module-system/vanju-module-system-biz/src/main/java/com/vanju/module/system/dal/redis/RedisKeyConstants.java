package com.vanju.module.system.dal.redis;
...
public interface RedisKeyConstants {
    ...
    String TRANS_STATION_CHILDREN_ID_LIST = "trans_station_children_ids";
    ...
    /**
     * 查询实时数据，每个用户的最后一次数据的时间
     */
    String REALTIME_DATA_ENDTIME = "realtime_data_endtime:%d";
}

package com.vanju.module.infra.controller.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(com.vanju.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "万炬源码，牛逼！")
    @ExcelProperty("结果提示")

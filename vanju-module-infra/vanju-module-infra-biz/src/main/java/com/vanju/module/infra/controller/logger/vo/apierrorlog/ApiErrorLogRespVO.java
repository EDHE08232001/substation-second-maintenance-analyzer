package com.vanju.module.infra.controller.logger.vo.apierrorlog;
...
import com.vanju.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(com.vanju.module.system.enums.DictTypeConstants.USER_TYPE)
